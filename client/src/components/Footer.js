      ...
      <div className="basic-footer text-center gray-bg ptb-90">
        <div className="container">
          ...
          <div className="footer-menu mt-30">
						{/* <nav>
							<ul>
								<li><a target="_blank"  rel="noreferrer"  href="https://opensea.io/collection/">OpenSea</a></li>
								<li><a target="_blank"  rel="noreferrer" href="https://etherscan.io/address/0xcf94f9a9add6205718750acff8e4fd1084dcf0f9">Verified Contract</a></li>
							</ul>
						</nav> */}
					</div>
